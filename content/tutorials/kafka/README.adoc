...
https://qaprodauth.cloud.redhat.com/beta/application-services/streams/kafkas?quickstart=getting-started[Connect to Application Services - Streams for Apache Kafka,role="tutorial-external"]
...
https://console-openshift-console.apps.sandbox-m2.ll9k.p1.openshiftapps.com/topology/ns/jschuler-kafka-devexp-dev/graph?quickstart=quarkus[Connect to OpenShift,role="tutorial-external"]
