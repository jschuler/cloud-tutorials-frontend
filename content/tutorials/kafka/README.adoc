...
https://console-openshift-console.apps.sandbox.x8i5.p1.openshiftapps.com/topology/ns/jschuler-kafka-devexp-dev/graph?quickstart=rhosak-devsandbox-quarkus-bind-cli-toolscontainer-quickstart[Connect to OpenShift,role="tutorial-external"]
